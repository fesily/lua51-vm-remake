...
if _VERSION == "Lua 5.1" then
	assert(debug.traceback(co):find("debug.lua") > 0)
	assert(debug.traceback(co, "hello"):find("hello") > 0)
	assert(debug.traceback(co, "hello"):find("debug.lua") > 0)
	assert(debug.traceback(co, "hello", 2):find("hello") > 0)
	assert(debug.traceback(co, "hello", 2):find("debug.lua") == nil)
else
...
assert(debug.traceback(co2):find("debug%.lua:%d+: in function"))
